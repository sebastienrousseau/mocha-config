...
This document describes how @sebastienrousseau/mocha-config is run: who decides what, how
...
@sebastienrousseau/mocha-config is **maintainer-led**. As of the current release line it has a single
