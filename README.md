...
<p align="center">
  Shareable Mocha test runner configuration files and rules
</p>
...
<p align="center">
  ...
  <a href="https://www.npmjs.com/package/@sebastienrousseau/mocha-config"><img src="https://img.shields.io/npm/v/%40sebastienrousseau%2Fmocha-config.svg?style=for-the-badge&color=fc8d62&logo=npm" alt="npm package" /></a>
  <a href="https://sebastienrousseau.com/mocha-config/"><img src="https://img.shields.io/badge/docs-sebastienrousseau.com-brightgreen.svg?style=for-the-badge&logo=github" alt="Documentation" /></a>
  ...
  <a href="https://www.bestpractices.dev/projects/14513"><img src="https://img.shields.io/cii/level/14513?style=for-the-badge&label=OpenSSF%20Best%20Practices&logo=openssf" alt="OpenSSF Best Practices" /></a>
...
- [BDD Test Execution Settings](#bdd-test-execution-settings) — before and after rule comparison
...
Install `@sebastienrousseau/mocha-config` as a development dependency:
...
Mocha reads `.mocharc.cjs` from the repository root.
...
`@sebastienrousseau/mocha-config` solves this with three deliberate engineering choices:
...
When your test suite is authored specifically for Jest or Vitest test runners with global test matchers.
