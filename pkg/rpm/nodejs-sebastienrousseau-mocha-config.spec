...
%global npm_bare      mocha-config
%global sitelib       %{_prefix}/lib/node_modules

Name:           nodejs-sebastienrousseau-mocha-config
Version:        0.0.7
Release:        1%{?dist}
Summary:        Shareable Mocha test runner configuration files and rules

License:        Apache-2.0 OR MIT
URL:            https://github.com/sebastienrousseau/mocha-config
Source0:        %{name}-%{version}.tar.gz
BuildArch:      noarch
Requires:       nodejs >= 20

%description
@sebastienrousseau/mocha-config is a shareable configuration preset with no runtime
